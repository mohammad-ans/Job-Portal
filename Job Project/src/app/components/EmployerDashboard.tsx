          ...
          <div className="bg-white p-6 rounded-3xl shadow-sm border border-slate-200/60 flex flex-col items-center text-center">
            ...
            <div className="mt-8 w-full pt-6 border-t border-slate-100 grid grid-cols-2 gap-4">
              ...
              <div className="bg-emerald-50 rounded-2xl p-4 border border-emerald-100">
                <p className="text-3xl font-black text-emerald-600 mb-1">{candidates.length}</p>
                <p className="text-[10px] text-emerald-600/80 font-bold uppercase tracking-wider">Candidates</p>
              </div>
            </div>
              ...
              <div className="divide-y divide-slate-100 flex-grow">
                {candidates.length === 0 ? (
                  <div className="flex flex-col items-center justify-center p-16 text-slate-400">
                    ...
                    <p className="font-semibold">No candidates yet for this job</p>
                  </div>
                ) : (
